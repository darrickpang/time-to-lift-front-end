...
export default class CoachClassContainer extends Component {
    ...
    handleSubmit = (e, addClass, updateClass) => {
        ...
        this.state.habitAdd ? addClass(class_info) : updateClass(this.state.id, class_info)
        this.setState({
            id: null,
            name: '',
            location: '',
                ...
                <CardBody>
                    <Form onSubmit={(e) => this.handleSubmit(e, addClass, updateClass)}>
                        <Row form>
                            <Col md={6}>
                                <FormGroup>
                                    <Input type="text" name="activity" id="activity" placeholder="Class name" value={this.state.name} onChange={this.handleOnChange}/>
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    <Input type="text" name="activity_type" id="activity-type" placeholder="Class location" value={this.state.location} onChange={this.handleOnChange}/>
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
                                    <Input type="text" name="activity_type" id="activity-type" placeholder="Class duration" value={this.state.duration} onChange={this.handleOnChange}/>
                                </FormGroup>
                            </Col>
                        </Row>
